    ...
    <div className="mx-auto max-w-5xl px-6 pt-20 pb-12">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          {query.isFetching && brandIdIsValid && (
      ...
      {query.isError && brandIdIsValid && (
        <div className="mt-6">
          <ApiErrorDisplay error={query.error} onRetry={() => query.refetch()} />
        </div>
      )}

      {brandIdIsValid && query.isLoading && <ListSkeleton />}

      {brandIdIsValid && !query.isLoading && !query.isError && items.length === 0 && (
